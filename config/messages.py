...
def mensageminicial():
    ...
    print('\33[1;37;40mMe avise: adriano.valumin@sovos.com \033[0m')
    print()
    print()
...
def empresas_nfe():
    ...
    print('\033[1;30;47m B \033[0m - \033[4mAxalta Coating Systems  RS  - 15373395001036\033[0m')
    print('\033[1;30;47m C \033[0m - \033[4mPaperless               SP  - 10726059000115\033[0m')
    print('\033[1;30;47m D \033[0m - \033[4mBrow Forman             SC  - 00305765000210\033[0m')
    print('\033[1;30;47m E \033[0m - \033[4mSignify Iluminação      MG  - 22555787000352\033[0m')
    print('\033[1;30;47m F \033[0m - \033[4mInfoglobo               RJ  - 04067191000755\033[0m')
    print('\033[1;30;47m G \033[0m - \033[4mEMS GERMED              SP  - 57507378000365\033[0m')
    print('\033[1;30;47m H \033[0m - \033[4mEdwards BR NFM          SP  - 05944604000533\033[0m')
    print('\033[1;30;47m I \033[0m - \033[4mOrica BR                PA  - 31056708001917\033[0m')
    print('\033[1;30;47m J \033[0m - \033[4mComp. de Dist.          MS  - 11517841003455\033[0m')
    print('\033[1;30;47m K \033[0m - \033[4mPhilips Medical         SP  - 58295213000178\033[0m')
    print('\033[1;30;47m L \033[0m - \033[4mPhilips Medical         MG  - 58295213002111\033[0m')
    print('\033[1;30;47m M \033[0m - \033[4mBiomerieux              RJ  - 33040635000171\033[0m')
    print('\033[1;30;47m N \033[0m - \033[4mSabo Autopeças          SP  - 60860681001323\033[0m')
    print()
    print('Certo, e qual das empresas acima deseja utilizar no IDOC?')
...
def tryagain():
    ...
    while len(vmdestino) != 2:
        print ('\033[91mOpa! Você deve inserir 2 dígitos! \033[0m')
        vmdestino = input('Digite novamente o número da VM: ')
    print('\033[93mTentando enviar o IDOC para INVQASRV'+ str(vmdestino))
    print('\033[0m')
    print()
    try:
        print('\033[93mEste processo pode levar até 30 segundos... \033[0m')
        print()        
        ...
        if tentarnovamente in ("n", "nao", "não", "no", "not"):
            print()
            print('\033[92mOk! O documento gerado está dentro da pasta IDOC ;) \033[0m')